...
export default function WalletInput({
  ...
  return (
    <div
      className={styles.walletInputOverlay}
      onClick={(e) => {
    ...
    >
      <div className={styles.walletInputModal} onKeyDown={handleKeyDown}>
        ...
        <p className={styles.walletSubtitle}>
          Paste your Ronin wallet address to load your cards. A loaded wallet
          can only be removed after 24 hours.
        </p>
        ...
        <div className={styles.walletTimeNote}>
          <p>+10k cards: 3m - 5m</p>

...
def build_features_for_moki(moki_id, matches, moki_details, class_overrides):
    ...
    for match in matches:
        ...
        # Composiciones ordenadas alfabéticamente (igual que en _2_preprocess.py)
        ...
        enemy_cls  = enemy_champ.get("class") if enemy_champ else "Unknown"
        ...
        feat = {
            ...
            "enemy_champ_class": enemy_cls or "Unknown",
            "team_comp":         team_comp,

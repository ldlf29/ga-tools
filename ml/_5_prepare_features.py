...
Crea la matriz de features incluyendo identidad e interacciones.
"""
...
def prepare_features():
    ...
    print("[INFO] Creando interaction features (Moki A vs Moki B)...")
    # Interaction entre IDs de Mokis
    df["moki_vs_enemy"] = df["moki_token_id"].astype(str) + "_vs_" + df["enemy_champ_token_id"].astype(str)
    
    print("[INFO] Features creadas exitosamente.")

    # Variables Seleccionadas
    feature_cols = ["moki_token_id", "enemy_champ_token_id", "moki_vs_enemy", "champ_class", "enemy_champ_class"]
    ...
    target_cols = [
        ...
        "res_deaths", "res_deposits", "res_wart_closer", "match_date"
    ]
    ...
    # Eliminar filas con nulos en las features base
